...
class _MultiSelectNestedState extends State<MultiSelectNested> {
  ...
  void initState() {
    ...
    if (widget.controller != null) {
      ...
      widget.controller!.validateSelection = validateSelection; // Add validation method to controller
    }
  }
 ...
 Widget _isEmptyItem(){
      return Text(widget.noItemSelect,
        style: const TextStyle(color: Colors.red,overflow: TextOverflow.ellipsis),);
 }
  @override
  Widget build(BuildContext context) {
    print('widget.validationTriggered ${widget.validationTriggered}');
    return Column(
      ...
      children: [
        Container(
          decoration: BoxDecoration(
              border: Border.all(
                color: widget.validationTriggered && !widget.controller!.validateSelection() ? Colors.red
